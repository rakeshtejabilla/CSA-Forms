      ...
      <div ref={dashboardRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 min-h-[400px]">
        {dashboard.widgets.length === 0 ? (
          ...
          dashboard.widgets.map((w: any) => (
            <div key={w.id} className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm flex flex-col gap-4 relative group" style={{ gridColumn: `span ${w.layout?.w || 1}` }}>
